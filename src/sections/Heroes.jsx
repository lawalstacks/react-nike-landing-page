...
const Heroes = () => {
    ...
    return(
        <section
        id = "home"
        className ="w-full xl:flex-row justify-center min-h-screen gap-10 max-container">
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-xl bold font-montserrat text-coral-red">Our Summer Collection</p>
        <h1 className="mt-10 font-palanquin font-bold text-8xl max-sm:text-[72px] max-sm:leading-[82px]">
        <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10" >The New Arrival</span>
        <br/>
        <span clasName="text-coral-red inline-block mt-3">Nike</span> Shoes
        </h1>
	    ...
	    iconURL = {arrowRight} />
	<div className="flex justify-starts items-start fkex-wrap w-full mt-20 gap-16">
	    {statistics.map((stat) =>
	(
		<div key={stat.label}>
